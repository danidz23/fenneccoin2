...
$apiKey = '7623205672:AAGfj5YuD_QAlcRDTpeuBNg3EIoNOwI8wZI'; // Your Telegram bot API key
...
if ($text === '/start') {
    ...
    $caption = "
    👋 **Welcome to the FennecCoin Adventure!** 🐾🎮

    Get ready for a tail-wagging journey where every paw-tap leads to bigger rewards! Here’s what’s waiting for you:

    ✨ **Play FennecCoin**: Tap the dog bone and watch your balance fetch amazing rewards!
    🐕 **Mine for PUPS**: Collect FennecCoin Tokens with every action your furry friend takes.
    ...
    🐾 **Get Started Now** and take your dog on the ultimate FennecCoin adventure!

    👉 [Join Our Doggo Community](https://t.me/FennecCoinAirdrop)
    ";
